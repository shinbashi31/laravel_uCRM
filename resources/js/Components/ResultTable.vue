...
<template>
    <div v-if="data.type === 'perDay' || data.type === 'perMonth' || data.type === 'perYear'"
        class="lg:w-3/4 mx-auto overflow-auto flex justify-center my-6">
    ...
    <div v-if="data.type === 'decile'" class="lg:w-3/4 mx-auto overflow-auto flex justify-center my-6">
        <table class="table-auto w-3/4 text-left whitespace-no-wrap">
            <thead>
                <tr>
                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">
    ...
    <div v-if="data.type === 'rfm'">
        <h2 class="text-center text-lg font-semibold text-gray-700 mt-6">RFM 分析結果</h2>
        <div class="my-2 text-center">合計: {{ data.totals }} 人</div>

        <h3 class="text-center text-lg font-semibold text-gray-700 mt-12">RFMランク毎の人数</h3>
        <div class="lg:w-3/4 mx-auto overflow-auto flex justify-center my-4">
            <table class="table-auto w-3/4 text-left whitespace-no-wrap">
                <thead>
                    <tr>
        ...
        <h3 class="text-center text-lg font-semibold text-gray-700 mt-12">RとFの集計表</h3>
        <div class="lg:w-3/4 mx-auto overflow-auto flex justify-center my-4">
            <table class="table-auto w-3/4 text-left whitespace-no-wrap">
                <thead>
                    <tr>
